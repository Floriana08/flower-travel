...
export const metadata: Metadata = {
  ...
  description:
    "Altrove Journey Design — a written travel strategy covering destinations, route, pace, budget and hotel style, built around a questionnaire, a review and a video call.",
  alternates: {
    ...
    <main>
      <section className="section-shell page-top plan-trip-layout">
        <div>
          ...
          >
            <p>
              Journey Design is expertise you purchase, not a quick chat. It
              becomes a document you keep, built around how you actually want
              to travel — not a generic template.
            </p>
            <p>
            ...
            <p className="plan-trip-aside">
              Investment: from €450 per Journey Design.{" "}
      ...
      <section className="section-shell tinted consultation-page-grid">
        ...
        <aside className="booking-panel">
          ...
          <p>
            Journey Design is not a full day-by-day itinerary, and we do not
            make bookings or hold reservations on your behalf. What you
            receive is the thinking — clear enough to hand to a travel agent,
            or to book yourself with confidence.
          </p>
          <p>
            It also isn’t built for last-minute trips — the process needs
            room to breathe. We take on a limited number of Journey Designs
            each month, so the thinking stays unhurried.
          </p>
          <p className="small-print">
            ...
            to hear when full Private Journey opens.
          </p>
        </aside>
      </section>
    </main>
