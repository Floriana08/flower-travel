...
export const metadata: Metadata = {
  title: "A Lisbon trip, shaped as rhythm",
  description:
    "A sample Altrove journey through Lisbon — arrival to evening, shaped as flow rather than a day-by-day itinerary.",
  alternates: {
    canonical: "https://altrove.studio/trips/lisbon",
  },
  openGraph: {
    title: "A Lisbon trip, shaped as rhythm | Altrove",
    description:
      "We don’t plan trips hour by hour. We shape the flow — where to base yourself, what deserves a reservation, and where to leave room.",
    images: [
      {
  ...
  return (
    <main className="trip-lisbon">
      <section className="trip-hero section-shell">
        <p className="trip-kicker">Sample Altrove trip</p>
        <h1>Lisbon, as a rhythm</h1>
        ...
        <p className="trip-sample-note">
          ...
          example of how Lisbon could flow.
        </p>
      ...
      <section className="trip-rhythm section-shell" aria-labelledby="trip-rhythm-title">
      ...
      <section className="trip-deeper section-shell" aria-labelledby="trip-deeper-title">
        <h2 id="trip-deeper-title">Want more of Lisbon?</h2>
        <p>
          This page shows how Altrove shapes a trip — not the whole destination
          guide. For deeper reading:
        </p>
        <ul className="trip-deeper-links">
          <li>
            <Link href="/destinations/portugal">Lisbon destination guide</Link>
          </li>
          <li>
            <Link href="/journal/where-to-eat-lisbon">Where to Eat in Lisbon</Link>
          </li>
          <li>
            <Link href="/journal/where-to-stay-lisbon">Where to Stay in Lisbon</Link>
          </li>
        </ul>
      </section>

      <section className="trip-yours section-shell" aria-labelledby="trip-yours-title">
        <h2 id="trip-yours-title">Yours would look different.</h2>
        <p>
          Tell Altrove where you&apos;re going, what matters to you and how you
          like to travel. We&apos;ll shape the trip around you.
        </p>
