...
export const studioCountries: StudioCountry[] = [
  {
    ...
    hubLede:
      "Italy rewards fewer bases and more time at the table. This collection begins in Campania — Naples and the coast Flor knows personally — and grows only when a route has been walked, stayed and edited.",
    example: {
  ...
  },
  {
    ...
    hubLede:
      "Portugal is Altrove’s clearest mainland collection so far — Lisbon to Porto by train, neighbourhood bases, and pacing that lets a first visit feel lived-in.",
    example: {
  ...
  },
  {
    ...
    hubLede:
      "Spain enters the collection when a route has enough first-hand texture to stand behind — food, landscape and character over the default city checklist.",
    example: {
