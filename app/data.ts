...
export const guides = [
  {
    ...
    excerpt:
      "The right neighbourhood can make Lisbon wonderfully easy. How Chiado, Príncipe Real, Avenida da Liberdade, Alfama and the rest compare — and which hotels are worth considering.",
  },
  {
    slug: "where-to-eat-lisbon",
    section: "destinations",
    title: "Where to Eat in Lisbon: The Restaurants Worth Knowing",
    category: "Food Guide",
    destination: "Lisbon",
    date: "August 18, 2026",
...
export const guideProducts: GuideProduct[] = [
  ...
  },
  {
    ...
    sampleNote:
      "Related free reading: our Lisbon stay and restaurant notes cover the same neighbourhoods at a lighter level of detail.",
    ...
    relatedArticleSlugs: ["where-to-stay-lisbon", "where-to-eat-lisbon"],
  ...
  },
  {
    ...
    sampleNote:
      "A Madeira planning companion for bases, levadas, weather-flex days and comfort-first logistics — published when the island is researched to the same standard as our Lisbon notes.",
    deliveryNote: "Instant PDF download by email once checkout is live.",
