...
export const metadata: Metadata = {
  title: "Guides",
  description:
    "Altrove digital guides — deeper than the journal, shorter than a Journey Blueprint. Starting with Campania.",
  alternates: {
    ...
    <main>
      <section className="section-shell page-top">
        ...
        <p className="journeys-studio-single-lede">
          A guide is deeper than a journal entry and narrower than a Journey
          Blueprint — one region, considered in full. We are starting with
          one, not twelve, and will only add another once it earns its place.
        </p>
      </section>
